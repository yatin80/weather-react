        ...
        <>
            ...
            <div className='city-other-details'>
                <div className='other-details-item'>
                    <h5 className='other-details-item-label'><i className="bi bi-wind me-2"></i>Wind</h5>
                    <div className='other-details-item-value'>{props.wind} <span style={{ fontWeight: '300' }}>km/h</span></div>
                </div>
                <div className='other-details-item'>
                    <h5 className='other-details-item-label'><i className="bi bi-droplet-fill me-2"></i>Humidity</h5>
                    <div className='other-details-item-value'>{props.humidity}<span style={{ fontWeight: '300' }}>%</span></div>
                </div>
                <div className='other-details-item'>
                    <h5 className='other-details-item-label'><i className="bi bi-brightness-low me-2"></i>UV Index</h5>
                    <div className='other-details-item-value'>{props.uvIndex}</div>
                </div>
                <div className='other-details-item'>
                    <h5 className='other-details-item-label'><i className="bi bi-thermometer me-2"></i>Pressure</h5>
